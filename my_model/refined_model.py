...
class HumanitarianModel(mesa.Model):
    ...
    def __init__(self, num_beneficiaries=30, num_trucks=3, width=20, height=20, seed=None, critical_days_threshold=5):
        """
    ...
    def get_total_deaths(model):
        ...
        # We need to manually calculate this based on initial count vs current count
    ...
    def get_critical_count(model):
        ...
        return sum(1 for a in model.agents if isinstance(a, Beneficiary) and a.is_critical)
